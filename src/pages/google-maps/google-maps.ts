...
export class GoogleMapsPage {
    ...
    showMap(){
        ...
        var locations = [
            ['Fredriksdal', 58.9644444, 17.4625, "Gnupa  lät resa denna sten efter Gudlev, sin broder. Han ändades österut i krigstjänst", [
                "assets/audio/fornnordiska/Nr4 Fredriksdal(fo).m4a", " assets/audio/svenska/Nr4 Fredriksdal(sv).m4a"],[
            ...
            ['Kristinedal', 58.97, 17.425555555555558, "Holmsten och Vigunn de läto resa stenen efter hennes son, och Vihjälm efter Ingefast.", [
                "assets/audio/fornnordiska/Nr5 Kristinedahl(fo).m4a", " assets/audio/svenska/Nr5 Kristinedahl(sv).m4a"],[
            ...
            ['Norastenen', 58.9661111, 17.541111111111114, "Ingemar och Ärnvi lät resa denna sten och göra bro efter Stenkil, sin son. Gud hjälpe hans ande. (Hela texten är känd från historisk nedteckning)",[
                "assets/audio/fornnordiska/Nr11 Nora(fo).m4a", " assets/audio/svenska/Nr11 Nora(sv).m4a"],[
            ...
            ['Tjuvstigen', 58.9777778, 17.54527777777778, "Lät Ingeger resa ännu en sten efter sina söner, gjorde dem synliga. Gud hjälpe deras ande. Torer högg",[
                "assets/audio/fornnordiska/Nr1 Tjuvstigen(fo).m4a", " assets/audio/svenska/Nr1 Tjuvstigen(sv).m4a"],[
            ...
            ['Långbro', 58.9286111, 17.477777777777778, "Vigöt och Ingjald och Assur, de reste denna sten efter Sven, sin fader.",[
                "assets/audio/fornnordiska/Nr8 LÜngbro(fo).m4a", " assets/audio/svenska/Nr8 LÜngbro(sv).m4a"],[
            ...
            ['Skåängstenen', 58.9638889, 17.43138888888889, "Harje, Ljug eller Härljug(?). Skamhals och Olöv de lät göra dessa märken  efter Sven, sin fader. Gud hjälpe hans själ.",[
                "assets/audio/fornnordiska/Nr3 SkÜÑng(fo).m4a", " assets/audio/svenska/Nr3 SkÜÑng(sv).m4a"],[
            ...
            ['Bergastenen', 58.9363889, 17.498611111111114, "Finna, Salgäst.",[
                "assets/audio/fornnordiska/Nr13 Berga(fo).m4a", " assets/audio/svenska/Nr13 Berga(sv).m4a"],[
            ...
            ['Västerljungkyrka', 58.9219444, 17.448888888888888,"Honäv reste efter Germar, sin fader. Han är ändad i Tjust. Skamhals högg dessa runor.", [
                "assets/audio/fornnordiska/Nr12 VÑsterljungs kyrka(fo).m4a", " assets/audio/svenska/Nr12 VÑsterljungs kyrka(sv).m4a"],[
            ...
            ['Björke', 58.9241667, 17.459166666666665, "Tatte högg efter sin fader Skacke (Skage), det stora minnesmärket man alltid skall omtala", [
                "assets/audio/fornnordiska/Nr6 Bjîrke(fo).m4a", " assets/audio/svenska/Nr6 Bjîrke(sv).m4a"],[
            ...
            ['Erikslund Gillberga', 58.9161111, 17.450833333333332,"Sigvalde reste ... efter Torkel(?), sin bryte.", [
                "assets/audio/fornnordiska/Nr7 Gillberga(fo).m4a", " assets/audio/svenska/Nr7 Gillberga(sv).m4a"],[
            ...
            ['Ytterstene', 58.9161111, 17.549463699999933,"Faste och Ospak(?) lät resa stenen efter Sigvat, sin broder.", [
                "assets/audio/fornnordiska/Nr9 Ytterstene(fo).m4a", " assets/audio/svenska/Nr9 Ytterstene(sv).m4a"],[
